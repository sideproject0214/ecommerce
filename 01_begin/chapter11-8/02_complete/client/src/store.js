...
import orderReducer from "./redux/slices/orderSlice"; // ch7
import adminReducer from "./redux/slices/adminSlice"; // ch10
...
export const store = configureStore({
  reducer: combineReducers({
    ...
    order: orderReducer, // ch7
    admin: adminReducer, // ch10
