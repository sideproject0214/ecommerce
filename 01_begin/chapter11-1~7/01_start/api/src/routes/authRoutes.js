...
const { auth } = require("../middleware/authMiddleware"); // ch9
...
// @desc     change password
// @access   private ch9
router.route("/mypage/pwchange").put(auth, myPwChange);

// @route    GET  api/auth/mypage/check
// @desc     Initial Password Check
// @access   Private ch9
router.route("/mypage/check").get(auth, initialPwCheck);
