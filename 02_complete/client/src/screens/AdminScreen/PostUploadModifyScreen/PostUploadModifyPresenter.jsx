...
const PostUploadModifyPresenter = (props) => {
  return (
    <>
      {props.GetAdminPostByUuidLoading ||
      props.postModifyNoImageLoading ||
      props.postModifyImageLoading ? (
        <Modal>
          <WhiteLoader />
        </Modal>
      ) : (
        ...
        <div className="post-container">
              ...
              <div className="post-col__context__body">
                <div className="post-col__context__body__contents">
                  ...
                  <input
                    className={
                      props.borderRed
                        ? "post-col__context__body__contents__input border-red"
                        : "post-col__context__body__contents__input"
                    }
                    type="text"
                    name="name"
                    placeholder="상품 이름"
                ...
                >
                  ...
                  <div className="post-col__context__body__contents__bigbox__plusMinusBtn">
                    ...
                    >
                      <i className="fas fa-plus-circle" id="plus"></i>
                    </div>
                    <div
                      className="post-col__context__body__contents__bigbox__plusMinusBtn__minus"
                      onClick={props.plusMinusBtn}
                    >
                      <i className="fas fa-minus-circle" id="minus"></i>
                    </div>
                  </div>
                </div>
                <div className="post-col__context__body__contents">
          ...
          <div className="image-container">
            <div className="image-box">
              ...
              {props.mainImageNum === 0 &&
              props.productOne.image === undefined ? (
                <p>선택된 파일이 없습니다</p>
              ) : props.mainImageNum === 0 &&
                props.productOne.image !== undefined ? (
                <p>1개가 로드 되었습니다</p>
              ...
              <div className="main-image-preview-box">
                {props.defaultImage &&
                props.productOne.image !== undefined &&
                props.mainPreview === undefined ? (
                  <div className={"box"}>
                    <div className="box__image">
                      <img
                        src={props.productOne.image}
                        id="image__section"
                        alt="preview"
                      />
                      ...
                      <div
                        ...
                        onClick={props.loadedImageDelete}
                      >
                        <i
                          className="far fa-times-circle"
                          id={props.productOne.image}
                        ></i>
                      </div>
                    </div>
                  </div>
            ...
            <div className="image-box">
              ...
              {props.thumbnailNum === 0 &&
              props.loadedThumbnail.length === 0 ? (
                <p>선택된 파일이 없습니다</p>
              ) : props.thumbnailNum === 0 &&
                props.loadedThumbnail.length !== 0 ? (
                <p>
                  {props.thumbnailNum + props.loadedThumbnail.length}개가 로드
                  되었습니다
                </p>
              ) : props.thumbnailNum !== 0 &&
                props.loadedThumbnail.length !== 0 &&
                props.thumbnailNum + props.loadedThumbnail.length > 3 ? (
                <p className="alert">3개 이상 올릴 수 없습니다</p>
              ) : (
                <p>
                  {props.thumbnailNum + props.loadedThumbnail.length}개가
                  선택되었습니다
                </p>
              )}
              ...
              <div className="thumbnail-image-box">
                {props.loadedThumbnail.map((value, index) => {
                  return (
                    <div className="box" key={index}>
                      <div className="box__image">
                        <img src={value} id="image__section" alt="preview" />

                        <div
                          className="box__icons"
                          onClick={props.loadedThumbnailDelete}
                        >
                          <i className="far fa-times-circle" id={value}></i>
                        </div>
                      </div>
                    </div>
                  );
                ...
                props.loadedThumbnail.length + props.thumbnailNum <= 3
          ...
          <div className="post-upload-button-box" type="submit">
            <button
              ...
              onClick={props.modifyProductSubmit}
            >
              <p>상품 수정 올리기</p>
            </button>
          </div>
...
export default PostUploadModifyPresenter;
