...
const PostModifyUploadPresenter = (props) => {
  return (
    <>
      {props.loading ? (
        <Modal>
        ...
        <div className="post-container">
          ...
          <div className="image-container">
            ...
            <div className="image-box">
              ...
              />
              {/* {props.thumbnailNum  ===0 && props.loadedThumbnailImageNum ===0? (
              ...
              {props.thumbnailNum === 0 && props.newThumbnail.length === 0 ? (
                <p>선택된 파일이 없습니다</p>
              ) : props.thumbnailNum === 0 &&
                props.newThumbnail.length !== 0 ? (
                <p>
                  {props.thumbnailNum + props.newThumbnail.length}개가 로드
                  되었습니다
                </p>
              ) : props.thumbnailNum !== 0 &&
                props.newThumbnail.length !== 0 &&
                props.thumbnailNum + props.newThumbnail.length > 3 ? (
                <p className="alert">3개 이상 올릴 수 없습니다</p>
              ) : (
                <p>
                  {props.thumbnailNum + props.newThumbnail.length}개가
                  선택되었습니다
                </p>
              )}
              ...
              <div className="thumbnail-image-box">
                {props.newThumbnail.map((value, index) => {
                  return (
                ...
                props.newThumbnail.length + props.thumbnailNum <= 3
...
export default PostModifyUploadPresenter;
