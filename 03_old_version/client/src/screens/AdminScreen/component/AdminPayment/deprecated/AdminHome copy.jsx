...
const AdminHome = () => {
  ...
  const { adminSummary, totalSales } = useSelector((state) => state.admin);
  ...
  console.log(result, totalSales, adminSummary.reviewCount);
    ...
    <div className="admin__body__context">
      ...
      <div className="admin__body__context__recent-reviews">
        ...
        <table>
          ...
          <tbody>
            {adminSummary.reviewCount &&
              adminSummary.reviewCount.map((value, index) => (
                <tr key={index}>
