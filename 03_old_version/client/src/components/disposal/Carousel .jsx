  ...
  return (
    <section id="hero">
      <div className="hero-main container">
        <div className="hero-contents" ref={contentsSliderRef}>
          <h2>
            <span className="discount">
              {slides[current].sale ? slides[current].sale : ""}%
            </span>{" "}
            SUPER SALE
          </h2>
          <h1>
            <span>신년맞이</span>
            <span>감사 대잔치</span>
            <p>{slides[current].name ? slides[current].name : ""} </p>
          </h1>
        ...
        <div className="image" ref={imageSliderRef}>
          <img
